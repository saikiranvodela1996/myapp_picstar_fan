...
public class MagneticSensor {
    ...
    public MagneticSensor(final PhotoSelfieCameraActivity main_activity) {
        this.main_activity = main_activity;
    }

    public void initSensor(final SensorManager mSensorManager) {
        if( MyDebug.LOG )
    ...
    public void registerMagneticListener(final SensorManager mSensorManager) {
    ...
    public void unregisterMagneticListener(final SensorManager mSensorManager) {
        if( magneticListenerIsRegistered ) {
            if( MyDebug.LOG )
    ...
    public void checkMagneticAccuracy() {
        ...
        else if( main_activity.getPreview().isTakingPhotoOrOnTimer()) {
            if( MyDebug.LOG )
